...
if __name__ == "__main__":
    ...
    df = pd.read_json(f"./bay_v1/{args_due.output_inference_dir}_tau1_tau2_logs.json",lines=True)
    ...
    for idx, component_name in enumerate(range(num_classes)):
        ...
        if args_due.test_uncertainty == True:
            ...
            uncertainty, labels_train, _, name_list_train, _, _ = get_uncertainty(model, likelihood, train_val_loader, tsne=True)
